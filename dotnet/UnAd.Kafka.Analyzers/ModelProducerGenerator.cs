...
namespace UnAd.Kafka.Analyzers;
...
public class ModelProducerGenerator : IIncrementalGenerator {
    public void Initialize(IncrementalGeneratorInitializationContext context) {
        context.RegisterPostInitializationOutput(static postInitializationContext =>
            postInitializationContext.AddSource("EventModelAttribute.g.cs", SourceText.From("""
                namespace UnAd.Kafka {
                    [global::System.CodeDom.Compiler.GeneratedCode("UnAd.Kafka.Analyzers", "0.0.1")]
        ...
        var pipeline = context.SyntaxProvider.ForAttributeWithMetadataName(
            fullyQualifiedMetadataName: "UnAd.Kafka.EventModelAttribute",
    ...
    private static string GenerateProducer(Model model) => $$"""
        ...
        namespace UnAd.Kafka {
            [global::System.CodeDom.Compiler.GeneratedCode("UnAd.Kafka", "0.0.1")]
            public sealed partial class {{model.ModelTypeName}}Producer(string topic, global::Confluent.Kafka.ProducerConfig producerConfig): global::UnAd.Kafka.KafkaMessageProducer<{{model.KeyNamespace}}.{{model.KeyTypeName}}, {{model.ModelNamespace}}.{{model.ModelTypeName}}> {
                ...
                internal sealed class {{model.ModelTypeName}}Serializer : global::Confluent.Kafka.ISerializer<{{model.ModelNamespace}}.{{model.ModelTypeName}}> {
                    public byte[] Serialize({{model.ModelNamespace}}.{{model.ModelTypeName}} data, global::Confluent.Kafka.SerializationContext context) =>
                        global::System.Text.Json.JsonSerializer.SerializeToUtf8Bytes(data/*, global::UnAd.Kafka.{{model.ModelTypeName}}SerializerContext.Default.{{model.ModelTypeName}}*/);
                }
                ...
                internal sealed class {{model.KeyTypeName}}Serializer : global::Confluent.Kafka.ISerializer<{{model.KeyNamespace}}.{{model.KeyTypeName}}> {
                    public byte[] Serialize({{model.KeyNamespace}}.{{model.KeyTypeName}} data, global::Confluent.Kafka.SerializationContext context) => 
                        global::System.Text.Json.JsonSerializer.SerializeToUtf8Bytes(data/*, global::UnAd.Kafka.{{model.KeyTypeName}}SerializerContext.Default.{{model.KeyTypeName}}*/);
                }
