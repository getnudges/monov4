...
public class PlanSubscriptionMiddlewareTests : KafkaTestBase {
    ...
    private readonly Mock<IUnAdClient> _mockUnAdClient;
    ...
    public PlanSubscriptionMiddlewareTests() {
        ...
        _mockUnAdClient = new Mock<IUnAdClient>();
        ...
        services.AddSingleton(_mockUnAdClient.Object);
    ...
    public async Task PlanSubscriptionMiddlewareHandlesPlanSubscriptionCreatedEvent() {
        ...
        // Assert
        _mockUnAdClient.Verify(x => x.GetPlanSubscriptionById.ExecuteAsync(planSubscriptionId, It.IsAny<CancellationToken>()), Times.Once);
        _mockUnAdClient.Verify(x => x.UpdateClient.ExecuteAsync(It.IsAny<UpdateClientInput>(), It.IsAny<CancellationToken>()), Times.Once);
