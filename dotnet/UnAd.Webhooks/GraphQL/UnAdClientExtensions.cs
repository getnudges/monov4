...
public static class UnAdClientExtensions {
    ...
    public static async Task<Result<string, Exception>> SmsLocaleLookup(this IUnAdClient client, string phoneNumber, CancellationToken cancellationToken) {
    ...
    public static async Task<Result<IGetClientByPhoneNumber_ClientByPhoneNumber, Exception>> GetClientByPhoneNumber(this IUnAdClient client, string phoneNumber, CancellationToken cancellationToken) {
    ...
    public static async Task<Result<IGetPlanByForeignId_PlanByForeignId, Exception>> GetPlanByForeignId(this IUnAdClient client, string foreignId, CancellationToken cancellationToken) {
    ...
    public static async Task<Result<IGetPriceTierByForeignId_PriceTierByForeignId, Exception>> GetPriceTierByForeignId(this IUnAdClient client, string foreignId, CancellationToken cancellationToken) {
    ...
    public static async Task<Result<IGetClientByCustomerId_ClientByCustomerId, Exception>> GetClientByCustomerId(this IUnAdClient client, string customerId, CancellationToken cancellationToken) {
    ...
    public static async Task<Result<ICreatePaymentConfirmation_CreatePaymentConfirmation_PaymentConfirmation, Exception>> CreatePaymentConfirmation(this IUnAdClient client, CreatePaymentConfirmationInput input, CancellationToken cancellationToken) {
    ...
    public static async Task<Result<IPatchPriceTier_PatchPriceTier_Plan, Exception>> PatchPriceTier(this IUnAdClient client, PatchPriceTierInput input, CancellationToken cancellationToken) {
    ...
    public static async Task<Result<IPatchPlan_PatchPlan_Plan, Exception>> PatchPlan(this IUnAdClient client, PatchPlanInput input, CancellationToken cancellationToken) {
    ...
    public static async Task<Result<IDeletePriceTier_DeletePriceTier_Plan, Exception>> DeletePriceTier(this IUnAdClient client, DeletePriceTierInput input, CancellationToken cancellationToken) {
    ...
    public static async Task<Result<IDeletePlan_DeletePlan, Exception>> DeletePlan(this IUnAdClient client, DeletePlanInput input, CancellationToken cancellationToken) {
...
public class NotCustomerException() : Exception("It seems you are not a customer of UnAd.");
