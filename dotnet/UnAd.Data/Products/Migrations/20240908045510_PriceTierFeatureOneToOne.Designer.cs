...
namespace UnAd.Data.Products.Migrations
{
    ...
    [Migration("20240908045510_PriceTierFeatureOneToOne")]
    partial class PriceTierFeatureOneToOne
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UnAd.Data.Products.Models.Discount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("UnAd.Data.Products.Models.DiscountCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("UnAd.Data.Products.Models.Plan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("UnAd.Data.Products.Models.PlanSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("UnAd.Data.Products.Models.PriceTier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("UnAd.Data.Products.Models.PriceTierFeature", b =>
                {
                    b.Property<int>("PriceTierId")
                        .HasColumnType("integer")
                        .HasColumnName("price_tier_id");
                    ...
                    b.HasKey("PriceTierId")
                        .HasName("price_tier_features_pkey");

                    b.ToTable("price_tier_features", (string)null);
                });

            modelBuilder.Entity("UnAd.Data.Products.Models.Trial", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("UnAd.Data.Products.Models.TrialOffer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("UnAd.Data.Products.Models.Discount", b =>
                {
                    b.HasOne("UnAd.Data.Products.Models.DiscountCode", "DiscountCode")
                        .WithMany("Discounts")
                        .HasForeignKey("DiscountCodeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("discount_discount_code_id_fkey");

                    b.HasOne("UnAd.Data.Products.Models.PlanSubscription", "PlanSubscription")
                        .WithMany("Discounts")
            ...
            modelBuilder.Entity("UnAd.Data.Products.Models.DiscountCode", b =>
                {
                    b.HasOne("UnAd.Data.Products.Models.PriceTier", "PriceTier")
            ...
            modelBuilder.Entity("UnAd.Data.Products.Models.PriceTier", b =>
                {
                    b.HasOne("UnAd.Data.Products.Models.Plan", "Plan")
                        .WithMany("PriceTiers")
            ...
            modelBuilder.Entity("UnAd.Data.Products.Models.PriceTierFeature", b =>
                {
                    b.HasOne("UnAd.Data.Products.Models.PriceTier", "PriceTier")
                        .WithOne("PriceTierFeature")
                        .HasForeignKey("UnAd.Data.Products.Models.PriceTierFeature", "PriceTierId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("price_tier_features_price_tier_id_fkey");
            ...
            modelBuilder.Entity("UnAd.Data.Products.Models.Trial", b =>
                {
                    ...
                    b.HasOne("UnAd.Data.Products.Models.TrialOffer", "TrailOffer")
                        .WithMany("Trials")
