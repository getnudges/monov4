...
namespace UnAd.Configuration.Analyzers;
...
public class AppConfigurationGenerator : IIncrementalGenerator {
    public void Initialize(IncrementalGeneratorInitializationContext context) {
        context.RegisterPostInitializationOutput(static postInitializationContext =>
            postInitializationContext.AddSource("ConfigurationKeyAttribute.g.cs", SourceText.From("""
                namespace UnAd.Configuration {
                    [global::System.CodeDom.Compiler.GeneratedCode("UnAd.Configuration.Analyzers", "0.0.1")]
        ...
        var pipeline = context.SyntaxProvider.ForAttributeWithMetadataName(
            fullyQualifiedMetadataName: "UnAd.Configuration.ConfigurationKeyAttribute",
    ...
    private static string GenerateClass(IEnumerable<Model> strings) => $$"""
        namespace UnAd.Configuration.Extensions {
            [global::System.CodeDom.Compiler.GeneratedCode("UnAd.Configuration.Analyzers", "0.0.1")]
