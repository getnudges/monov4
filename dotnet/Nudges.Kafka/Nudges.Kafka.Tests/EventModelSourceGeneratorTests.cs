...
using Nudges.Kafka.Generators;
//using VerifyCS = Nudges.Kafka.Tests.CSharpSourceGeneratorVerifier<Nudges.Kafka.Generators.EventModelSourceGenerator>;

namespace Nudges.Kafka.Tests;
...
public class EventModelSourceGeneratorTests {
    ...
    public void EventModelSourceGenerator1() {
        ...
        var inputCompilation = CreateCompilation("""
            namespace MyApp;
            using Nudges.Kafka.Abstractions;
...
//";
//        using var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("Nudges.Kafka.Tests.Matches.ClientEventSerializer.txt");
